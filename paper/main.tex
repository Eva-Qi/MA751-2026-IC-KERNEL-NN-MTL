...
% Figure 2: Complexity ladder schematic
\begin{figure}[t]
  \centering
  \fbox{\parbox{0.7\textwidth}{\centering
    \texttt{[fig\_ladder.pdf — schematic]}\\[6pt]
    Rung 1 (linear) $\to$ Rung 2 (regularized) $\to$ Rung 3 (additive) $\to$
    Rung 4 (MLP) $\to$ Rung 5 (MTL+MoE)\\
    Showing 12 model variants and parameter counts
  }}
  \caption{The 5-rung complexity ladder. Each rung adds a strictly
  greater capacity to model the conditional return function.}
  \label{fig:ladder}
\end{figure}
